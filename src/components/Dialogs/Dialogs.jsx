...
import {addMessageActionCreator, updateMessageChangeActionCreator} from "../../redux/dialogs-reducer";
...
const Dialogs = (props) => {
   ...
   const onNewMassageChange = (e) => {
      ...
      props.store.dispatch(updateMessageChangeActionCreator(newMessageText))
   };
